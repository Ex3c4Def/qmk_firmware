...
// change default encoder settings
/* encoder */
...
// enable all available rgb matrix effects + the self defined
	...
	#define    ENABLE_RGB_MATRIX_ALPHAS_MODS_2
	#define    ENABLE_RGB_MATRIX_ALPHAS_MODS_S
	#define    ENABLE_RGB_MATRIX_ALPHAS_MODS_V
